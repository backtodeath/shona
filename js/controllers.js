angular.module('starter.controllers', [])
  ...
  .controller('BibleBooksCtrl', function ($scope, $stateParams, getBible, $state, settings, $rootScope) {
  ...
  .controller('BibleChaptersCtrl', function ($scope, $stateParams, getBible, $state, settings, $rootScope) {
  ...
  .controller('BibleTextCtrl', function ($window,$location, $scope, $stateParams, getBible, settings, $rootScope) {

	  $rootScope.title = $stateParams.book + ' Chapter: ' + $stateParams.chapter;
  ...
  .controller('SettingsCtrl', function ($scope, settings, $localStorage, $rootScope) {
